...
<style>
	...
	:global([data-theme='dark']) .theme-toggle .theme-toggle__within .theme-toggle__within__circle {
		transform: scale(1.5);
	}
	:global([data-theme='dark']) .theme-toggle .theme-toggle__within .theme-toggle__within__inner {
		transform: translate3d(3px, -3px, 0) scale(1.2);
	}
	:global([data-theme='dark']) .theme-toggle .theme-toggle__within g path {
